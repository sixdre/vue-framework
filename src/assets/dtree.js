...
function dTree(objName) {
	...
	this.icon = {
		root				: '/app/static/image/dtree/base.gif',
		folder			: '/app/static/image/dtree/folder.gif',
		folderOpen	: '/app/static/image/dtree/folderopen.gif',
		node				: '/app/static/image/dtree/page.gif',
		empty				: '/app/static/image/dtree/empty.gif',
		line				: '/app/static/image/dtree/line.gif',
		join				: '/app/static/image/dtree/join.gif',
		joinBottom	: '/app/static/image/dtree/joinbottom.gif',
		plus				: '/app/static/image/dtree/plus.gif',
		plusBottom	: '/app/static/image/dtree/plusbottom.gif',
		minus				: '/app/static/image/dtree/minus.gif',
		minusBottom	: '/app/static/image/dtree/minusbottom.gif',
		nlPlus			: '/app/static/image/dtree/nolines_plus.gif',
		nlMinus			: '/app/static/image/dtree/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
